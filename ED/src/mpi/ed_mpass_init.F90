...
subroutine ed_masterput_nl(par_run)
   ...
   use met_driver_coms      , only : ed_met_driver_db          & ! intent(in)
                                   ...
                                   , lapse_scheme, co2_scheme, co2_file              ! ! intent(in)
   ...
   call MPI_Bcast(nlsl ,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(co2_scheme,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(co2_file,str_len,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr)
...
!----- Now the namelist -------------------------------------------------------------------!
   ...
   call MPI_Bcast(nlsl ,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(co2_scheme,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(co2_file,str_len,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr)
