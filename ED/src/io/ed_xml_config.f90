...
! allocation variables
           ...
           call getConfigREAL  ('root2leaf_min','pft',i,rval,texist)
           if(texist) root2leaf_min(myPFT) = real(rval)
           call getConfigREAL  ('root2leaf_max','pft',i,rval,texist)
           if(texist) root2leaf_max(myPFT) = real(rval)
           call getConfigREAL  ('root_realloc_wet_thresh','pft',i,rval,texist)
           if(texist) root_realloc_wet_thresh(myPFT) = real(rval)
           call getConfigREAL  ('root_realloc_dry_thresh','pft',i,rval,texist)
           if(texist) root_realloc_dry_thresh(myPFT) = real(rval)
           call getConfigREAL  ('root_realloc_inc','pft',i,rval,texist)
           if(texist) root_realloc_inc(myPFT) = real(rval)
           call getConfigREAL  ('C_resorption_fraction','pft',i,rval,texist)
           if(texist) C_resorption_fraction(myPFT) = real(rval)
           call getConfigREAL  ('N_resorption_fraction','pft',i,rval,texist)
           if(texist) N_resorption_fraction(myPFT) = real(rval)
           call getConfigREAL  ('P_resorption_fraction','pft',i,rval,texist)
           if(texist) P_resorption_fraction(myPFT) = real(rval)
...
!! ALLOCATION
        ...
        call putConfigREAL("root2leaf_min",root2leaf_min(i))
        call putConfigREAL("root2leaf_max",root2leaf_max(i))
        call putConfigREAL("root_realloc_wet_thresh",root_realloc_wet_thresh(i))
        call putConfigREAL("root_realloc_dry_thresh",root_realloc_dry_thresh(i))
        call putConfigREAL("root_realloc_inc",root_realloc_inc(i))
        call putConfigREAL("C_resorption_fraction",C_resorption_fraction(i))
        call putConfigREAL("N_resorption_fraction",N_resorption_fraction(i))
        call putConfigREAL("P_resorption_fraction",P_resorption_fraction(i))
